...
def odometry_update_v2(delta_L,delta_R):
    global initialized2
    global x,y,th
...
def test1():
  ...
  while not done:
      ...
      if counter > 9:
        ...
        if b > 0:
          print("b=%5d, l_cmd=%4d, r_cmd=%4d, delta_L=%4d, delta_R=%4d, l_target=%4d, r_target=%4d x=%7.5f y=%7.5f th=%8.3f   x1=%7.1f y1=%7.1f th1=%8.3f" % (int(b),l_cmd,r_cmd,delta_L,delta_R,l_target,r_target,x,y,degs(norm(th)),x1,y1,degs(norm(th1))))
