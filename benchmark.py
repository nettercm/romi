...
n = 500
total_time = timeit.timeit(a_star.test_read32, number=n)
read_kbits_per_second = 32 * n * 8 / total_time / 1000

print("Reads of 32 bytes: "+'%.1f'%read_kbits_per_second+" kilobits/second")
